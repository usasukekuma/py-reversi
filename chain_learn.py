...
#  すべての試合の８割を訓練と検証に、、
train_iter = iterators.MultithreadIterator(train, batch_size=100, repeat=True, shuffle=True)
#  訓練データを100個＝１セットに　シャッフルもするお！
valid_iter = iterators.MultithreadIterator(test, batch_size=100, shuffle=False, repeat=False)
#  ------end------
